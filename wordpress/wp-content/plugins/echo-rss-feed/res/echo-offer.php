         ...
         <b>
            <ol>
               ...
               <li>
                  ...
                  <?php echo esc_html__("For more updates, tips and tricks follow our", 'rss-feed-post-generator-echo');?> <a href="https://coderevolution.ro/" target="_blank"><?php echo esc_html__("blog", 'rss-feed-post-generator-echo');?></a> + <?php echo esc_html__("subscribe to our newsletter from our blog, to get our affiliate marketing e-book, for free!", 'rss-feed-post-generator-echo');?>
               </li>
               <li>
