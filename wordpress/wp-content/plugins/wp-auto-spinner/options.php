					...
					<div>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<div class="description">Choose which language the plugin will rewrite the content in.</div></td>
										</tr>
							...
							<div class="inside">
								...
								<table class="form-table">
									<tbody>
										...
										<tr>
											<th scope="row"><label>Exclude capitals </label></th>
											<td>
						...
						<div class="postbox OPT_AUTO_SPIN_SC  spin_method_box" >
							...
							<div class="inside">
								...
								<p>By Default, the plugin uses it's internal synonyms database but you still can use <a href="http://www.whitehatbox.com/Agents/SSS?code=o484rg1x4/BSxXSuwed4BY9KWRedbqx1GSapvkPuytaDOooV9SfW4A==">SpinnerChief</a> API to spin the posts .</p>
