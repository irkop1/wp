...
jQuery(document).ready(function() {
	...
	jQuery('#wp-auto-spinner-stoeditor').click(function(){
		...
		if( typeof(wp) != "undefined" && wp.hasOwnProperty('data') && wp.data.hasOwnProperty('select') && typeof(wp.data.select('core/editor')) != 'undefined' && jQuery('.block-editor-inserter__toggle').length !=0 ){
